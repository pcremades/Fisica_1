...
public void setup() {
  ...
  Reiniciar = new GButton(this, width*0.8f, height*0.9f, 90, 30, "Reiniciar"); 

  plotPos = new GPlot(this);
  ws = new GPointsArray(wsN);
  plotPos.setPoints(ws);
  plotPos.setPos(20, 20);
  plotPos.setDim(width *0.82f, height*0.6f);
  plotPos.setYLim(0, 8);
...
public void draw() {
  ...
  text("Máxima Velocidad Angular = "+round(wsMax*100)/100.0f, width/4 + 30, height - 70);
}
